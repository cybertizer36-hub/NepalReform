        ...
        <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
          <CardHeader className="text-center space-y-4">
            ...
            <CardDescription className="text-muted-foreground">
              Create your account to start sharing opinions and engaging in democratic discourse <br /> <br /> We need your authintication only for the purpose of vote uniqueness. <br /> We do not store any of your data in simple text.    
            </CardDescription>
          </CardHeader>
          <CardContent>
